...
public class FXMLAdminAlumnoController implements Initializable, INotificacion {
    ...
    private void cargarInformacionTabla() {
        try {
            ...
            Utilidad.mostrarAlertaSimple(Alert.AlertType.ERROR, "Error al cargar", 
                    "Lo sentimos, por el momento no se puede mostrar la información de los alumno. "
    ...
    private void btnClicModificar(ActionEvent event) {
        ...
        if (alumno != null) {
            ...
            Utilidad.mostrarAlertaSimple(Alert.AlertType.WARNING, 
                    "Selecciona un alumno", "Para modificar la información de un alumno debes seleccionarlo primero.");
        }
    }
    ...
    private void btnClicEliminar(ActionEvent event) {
        ...
        if(pos >= 0) {
            ...
            String confirmacion = String.format("¿Estás seguro de eliminar el registro del alumno(a) %s %s?"
            ...
            Utilidad.mostrarAlertaSimple(Alert.AlertType.WARNING, 
                    "Selecciona un alumno", "Para eliminar el registro de un alumno debe seleccionarlo primero.");
        }
    }
    ...
    private void irFormularioAlumno(boolean esEdicion, Alumno alumnoEdicion) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(JavaFXAppEscolar.class.getResource(
    ...
    private void eliminarAlumno(int idAlumno) {
        try {
            ...
            Utilidad.mostrarAlertaSimple(Alert.AlertType.ERROR, "Problemas al eliminar", "Lo sentimos, por el momento no se puede realizar la operación");
        }
    }
}
